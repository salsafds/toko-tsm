    ...
    public function update(Request $request, $id_pembelian)
{
    $request->validate([
        ...
        'details.*.harga_beli' => 'required|numeric|min:0',
        'details.*.kuantitas' => 'required|integer|min:1',
        'details.*.id_detail_pembelian' => 'nullable|exists:detail_pembelian,id_detail_pembelian', // Tambahkan validasi untuk ID detail
    ]);
    ...
    // Tambahkan di akhir class PembelianController
    public function storeBarang(Request $request)
    {
        // Validasi khusus untuk tambah barang
        $request->validate([
