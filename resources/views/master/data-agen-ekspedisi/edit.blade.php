...
@section('title', 'Edit Agen Ekspedisi')

@section('content')
<div class="container mx-auto p-6">
  <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-6">
    <h2 class="text-lg font-semibold text-gray-800 mb-4">Edit Data Agen Ekspedisi</h2>

    @include('master.data-agen-ekspedisi._form', [
      'action' => route('master.data-agen-ekspedisi.update', $agen->id_ekspedisi),
      'method' => 'PUT',
      'agen' => $agen,
      'nextId' => null,
      'negara' => $negara,
