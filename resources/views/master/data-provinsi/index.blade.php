...
<div class="container mx-auto">
  <div class="flex items-center justify-between mb-6">
    <div>
      <h1 class="text-2xl font-semibold text-gray-800">Data Provinsi</h1>
  ...
  <div class="flex items-center justify-between mb-4">
    ...
    <div class="flex items-center gap-3">
      ...
      <a href="{{ route('master.data-provinsi.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-700 text-white rounded-md text-sm hover:bg-blue-800">
        + Tambah
      </a>
    </div>
  </div>
    ...
    <table class="min-w-full divide-y divide-gray-200 table-auto"> 
      <thead class="bg-gray-50">
        <tr class="text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
          <th class="w-32 px-4 py-3 border-r border-gray-200">ID Provinsi</th> 
          <th class="w-auto flex-1 border-r px-4 py-3">Nama Provinsi</th>
      ...
      <tbody class="bg-white divide-y divide-gray-100">
        @forelse($provinsis ?? collect() as $item)
          <tr class="hover:bg-gray-50 transition-colors">
            <td class="w-auto flex-1 border-r px-4 py-2 text-sm text-gray-700 border-gray-100">{{ $item->id_provinsi }}</td>
            <td class="w-auto flex-1 border-r px-4 py-2 text-sm text-gray-700"> {{ $item->nama_provinsi }}</td> 
